      ...
      <div className="bg-[url('/pattern2.svg')] bg-repeat animate-[scroll-pattern_100s_linear_infinite]">
        <div className="bg-[#FFF] flex-1 p-15 ml-[6vw] mr-[6vw] border-l-1 border-l-[#E1E1EE] border-r-1 border-r-[#E1E1EE] tracking-tighter min-h-screen">
          <div className="flex flex-row justify-start items-start ml-[3vw] mr-[3vw] gap-10">
            ...
            <div className="flex flex-row rounded-lg w-full min-h-[80vh]">
              <div className="flex flex-col w-40 border-1 border-[#e1e1e1] rounded-lg">

                <div className="hover:bg-[#fafafa] w-full text-center ease-linear duration-75 cursor-pointer border-b-1 border-b-[#e1e1e1]">
                  <h1 className="font-semibold text-sm mt-2 mb-2">Login Settings</h1>
                </div>

                <div className="hover:bg-[#fafafa] w-full text-center ease-linear duration-75 cursor-pointer border-b-1 border-b-[#e1e1e1]">
                  <h1 className="font-semibold text-sm mt-2 mb-2">Gameplay Preferences</h1>
                </div>

              </div>
              <div className="flex flex-col gap-5 text-xl">
                <h1 className="ml-5">Change Email</h1>
                <h1 className="ml-5">Change Username</h1>
                <h1 className="ml-5">Change Password</h1>
              </div>
            </div>
          </div>
        </div>
